...
void setup() {
  ...
  digitalWrite(relay1IN1, HIGH); // HIGH means relay off
  digitalWrite(relay1IN2, HIGH); // HIGH means relay off
  digitalWrite(relay2IN1, HIGH); // HIGH means relay off
  digitalWrite(relay2IN2, HIGH); // HIGH means relay off
...
void dispenseDrink(int drinkNumber) {
  switch (drinkNumber) {
    case 1: // Coca-Cola
      digitalWrite(relay1IN1, LOW); // Turn on pump 1
      delay(3000); // Dispense for 3 seconds
      digitalWrite(relay1IN1, HIGH); // Turn off pump 1
      break;
    case 2: // Sprite
      digitalWrite(relay1IN2, LOW); // Turn on pump 2
      delay(3000); // Dispense for 3 seconds
      digitalWrite(relay1IN2, HIGH); // Turn off pump 2
      break;
    case 3: // Mirinda
      digitalWrite(relay2IN1, LOW); // Turn on pump 3
      delay(3000); // Dispense for 3 seconds
      digitalWrite(relay2IN1, HIGH); // Turn off pump 3
      break;
  }
}
